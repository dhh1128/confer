...
1. Go to the [**Security** tab](https://github.com/dhh1128/confer/security) of this repository.
...
Confer is a personal open-source project. **We do not offer a paid bug bounty
...
Confer is pre-1.0 and ships from the `main` branch. Security fixes are applied
